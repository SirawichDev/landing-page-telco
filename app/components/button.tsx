import { ButtonHTMLAttributes, FC, ForwardedRef } from "react";
...
const classes = {
    ...
    custom: 'bg-accent text-light border border-transparent hover:bg-accent-hover hover:text-accent hover:border-accent',
    outline:
