...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create telco-2660
  fly apps create telco-2660-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app telco-2660
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app telco-2660-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'telco-2660-staging' does not match app name in config file 'telco-2660'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name telco-2660-db
  fly postgres attach --postgres-app telco-2660-db --app telco-2660

  fly postgres create --name telco-2660-staging-db
  fly postgres attach --postgres-app telco-2660-staging-db --app telco-2660-staging
  ```
